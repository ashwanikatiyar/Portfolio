...
export default function Footer() {
  return (
    <footer className="bg-black text-gray-300 py-10 px-4 border-t border-gray-700">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            user-centric web experiences. Reach out if you'd like to
            collaborate or have a project in mind!
          </p>
        </div>
      </div>
